...
<head>
  ...
  <title>Liste des assurance</title>
        ...
        <div class="col-lg-12">
          <div class="card" style="width: 990px;">
            <div class="card-body">
              ...
              <table class="table " style="width: 950px;" id="myTable">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php
                        ...
                        // if($s == 'pending'){
                        //   echo '<span class="bg-warning bg-opacity-75 rounded-pill fw-bold text-dark px-2">ECT...</span>';
                    ...
                    <td>
                      ...
                      if($e > $d){
                        ?>
                          <!-- <button type="submit" name="cancel" class="btn badge btn-sm bg-info " ><i class="bi bi-x-lg"></i></button> -->
                          <form action="" method="POST">
                          <button type="button" class="btn badge bg-info " data-bs-toggle="modal" data-bs-target="#exampleModal1<?php echo $client['id'];?>"><i class="bi bi-x-lg"></i></button>
                            <div class="modal fade" id="exampleModal1<?php echo $client['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Annuler :</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body">
                                    Êtes-vous sûr de annuler l'assurance ? <?php echo $client['immatriculation'];?>
                                  </div>
                                  <div class="modal-footer">
                                    <input type="hidden" name="id" value="<?php echo $client['id'];?>">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                                    <button type="submit" class="btn btn-info" name="cancel">Annuler</button>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      ?>
                      <!-- <button type="submit" name="" class="btn badge btn-sm bg-danger " ><i class="bi bi-trash-fill"></i></button> -->
                      <form action="" method="POST">
                      <button type="button" class="btn badge bg-danger" data-bs-toggle="modal" data-bs-target="#exampleModal2<?php echo $client['id'];?>"><i class="bi bi-trash-fill"></i></button>
                            <div class="modal fade" id="exampleModal2<?php echo $client['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                  ...
                                  <div class="modal-body">
                                    Êtes-vous sûr de supprimer l'assurance ? <?php echo $client['immatriculation'];?>
                                  </div>
                                  <div class="modal-footer">
                                    <input type="hidden" name="id" value="<?php echo $client['id'];?>">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                      ...
                      <!-- <a href="/tc/generatepdf1.php?id=<?php echo $client['id'];?>" ><button type="button" name="print" class="btn badge btn-sm bg-warning " ><i class="bi bi-printer-fill"></i></button></a> -->
                      <a href="tc/generatepdf1.php?id=<?php echo $client['id'];?>" ><button type="button" name="print" class="btn badge btn-sm bg-warning " ><i class="bi bi-printer-fill"></i></button></a>
                      </form>
                    </td>
                  </tr>
...
?>
              ...
              <!-- <p  sytyle="font-size: 2px;"><u>*ECT : En Cours de Traitement...</u></p> -->
            </div>
          </div>
        </div>
      </div>
