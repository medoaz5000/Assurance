...
<?php
  ...
  if(isset($_POST['login'])){
    ...
    $email =  $_POST['usernamec'];
    $password =  $_POST['password'];
    $sql = mysqli_query($db, "select * from inscription_admin where Email = '$email' AND Password = '$password' ");
    $num = mysqli_num_rows($sql);
      if($num >0){
        $row = mysqli_fetch_assoc($sql);
        $_SESSION['user_id'] = $row['id'];
        $_SESSION['usernamec'] = $row['Email'];
      }
  ...
  if(isset($_POST['remember'])){
    setcookie('usernamec',$_SESSION['usernamec'],time()+ 300 * 24 * 3600, null, null, false, true );
...
<head>
  ...
  <title>Se conncter | Sanlam </title>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="" >
                    ...
                    <div class="col-12 mt-5">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="usernamec" class="form-control" id="yourUsername" value="<?php if(isset($_COOKIE['usernamec'])){ echo $_COOKIE['usernamec'];}?>" required>
